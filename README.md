...
- **引导关 + 挑战关双模式**:多数关卡逐步引导,少数关卡(POP 链、CVE、真题)只给最少提示;
...
| Level 24 | 原生类与真实攻击面 | 原生类利用 | 引导 | ★★ |
| Level 25 | 原生类与真实攻击面 | 原生类 · Error / Exception | 引导 | ★★ |
| Level 26 | 原生类与真实攻击面 | 魔术方法跳板 __get / __call | 引导 | ★★★ |
